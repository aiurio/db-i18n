...
public abstract class DatabaseMessageSourceBase extends AbstractMessageSource {
    ...
    public String getMessage(Locale locale, String code) {
        return messages.getMessage(code, locale, fallbackLocale);
    }
    ...
    protected MessageFormat resolveCode(String code, Locale locale) {
        String msg = messages.getMessage(code, locale, fallbackLocale);
    ...
    protected final class Messages {
        ...
        public String getMessage(String code, Locale locale, Locale fallbackLocale) {
            String result = null;
            Map<String, String> data = messages.get(code);
            if (data != null) {
